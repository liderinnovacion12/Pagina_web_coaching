...
export function RegistroForm() {
  ...
  const plan = rawPlan === "curso" || rawPlan === "membresia" ? rawPlan : undefined;
  ...
  return (
    ...
    >
      {plan && (
        <div className="mb-4 flex items-center justify-center gap-2 rounded-xl border border-gold-500/20 bg-gold-500/10 px-4 py-2.5">
          <span className="font-mono text-xs text-gold-400 uppercase tracking-wider">
            {plan === "curso" ? "Plan por curso seleccionado" : "Plan Ilimitado seleccionado"}
          </span>
        </div>
      )}
