...
const CAMPO_CLASES =
  "h-11 w-full rounded-xl border border-white/10 bg-ink-950 pl-11 pr-4 text-base text-white placeholder:text-mist-500 outline-none transition duration-150 hover:border-white/20 focus:border-gold-500/60 focus:shadow-[0_0_0_4px_rgba(0,201,87,0.12)]";

export function RegistroForm({ plan, cursoId }: { plan?: string; cursoId?: string }) {
  ...
  return (
    ...
    >
      <form action={formAction} className="flex flex-col gap-4">
        ...
        {cursoId && <input type="hidden" name="curso_id" value={cursoId} />}
