...
5. **Secciones "en construcción" del área de estudiante**: `/marketing`, `/soporte` (`/calendario` y `/herramientas` ya se implementaron). Ver alcance objetivo en `docs/descripcion_contenido_pagina.txt` (sitio de referencia).
