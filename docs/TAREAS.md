...
5. **Ítems de navegación sin ruta** (`components/estudiante/nav-config.ts`, `href: null`): Acelerador Pro/Starter, Transacciones, Eventos, Construcción de Equipo, Oficinas.
